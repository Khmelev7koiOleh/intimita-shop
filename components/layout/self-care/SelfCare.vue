...
<template>
  <div
    class="w-full relative h-full flex flex-col justify-center py-20 items-end md:items-center"
  >
    <LayoutMobileFilter>
      <template #buttons>
        <LayoutFilterButtons
          :data="selfCare"
          :filter-name="'Self care'"
          :filter-type="'selfCareType'"
          :filter-data="selfCareFilter"
