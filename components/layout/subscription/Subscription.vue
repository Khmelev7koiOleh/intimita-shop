...
<template>
  <div class="md:px-20 h-full py-[60px] sm:py-[100px] lg:py-[140px]">
    ...
    >
      ...
      <div
        class="w-full sm:w-1/2 h-full flex flex-col gap-[5%] px-[4%] sm:px-[6%] mb-5 md:mb-0"
      >
        <h1
          class="text-[28px] sm:text-[36px] text-center md:text-left font-bold text-black pt-1"
        >
          Subscription
        </h1>
        <div class="px-[2%] flex flex-col gap-6 sm:gap-8">
          ...
          <div
            class="w-full flex justify-center md:flex-none md:justify-normal"
          >
